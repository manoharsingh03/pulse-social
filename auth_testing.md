...
# Test pulse creation
curl -X POST "${REACT_APP_BACKEND_URL}/api/pulse" \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer YOUR_SESSION_TOKEN" \
  -d '{"emotion": "stressed", "text": "Feeling overwhelmed today"}'
```
...
await page.context.add_cookies([{
    ...
    "domain": "pulse-social-6.preview.emergentagent.com",
    "path": "/",
    "httpOnly": true,
    "secure": true,
    "sameSite": "None"
}]);
await page.goto("https://pulse-social-6.preview.emergentagent.com/dashboard");
```

## Critical Fix: ID Schema
MongoDB + Pydantic ID Mapping with Field(alias="_id")
